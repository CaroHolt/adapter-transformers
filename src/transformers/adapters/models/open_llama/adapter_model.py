...
from ....models.open_llama.modeling_open_llama import OPEN_LLAMA_START_DOCSTRING, OpenLlamaModel, OpenLlamaPreTrainedModel
...
@add_start_docstrings(
    """
The OpenLlama Model that allows the loading of different heads dor different tasks. This enables a flexible use of the
...
class OpenLlamaAdapterModel(EmbeddingAdaptersWrapperMixin, ModelWithFlexibleHeadsAdaptersMixin, OpenLlamaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
        self.transformer = OpenLlamaModel(config)
    ...
    # Copied from OpenLlamaLMHeadModel
...
class OpenLlamaModelWithHeads(OpenLlamaAdapterModel):
