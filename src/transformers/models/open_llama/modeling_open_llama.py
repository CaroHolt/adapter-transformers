...
from ...adapters.mixins.open_llama import (
    OpenLlamaDecoderBlockAdaptersMixin,
    OpenLlamaModelAdapterMixin,
    OpenLlamaWithHeadsAdaptersMixin,
)
...
class OpenLlamaDecoderLayer(OpenLlamaDecoderBlockAdaptersMixin, nn.Module):
    def __init__(self, config: OpenLlamaConfig):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class OpenLlamaModel(OpenLlamaModelAdapterMixin, OpenLlamaPreTrainedModel):
    """
...
class OpenLlamaForCausalLM(OpenLlamaWithHeadsAdaptersMixin, OpenLlamaPreTrainedModel):
...
class OpenLlamaForSequenceClassification(OpenLlamaWithHeadsAdaptersMixin, OpenLlamaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
