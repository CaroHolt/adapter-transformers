...
class LlamaModel(LlamaModelAdapterMixin, LlamaPreTrainedModel):
    """
...
class LlamaForCausalLM(LlamaWithHeadsAdaptersMixin, LlamaPreTrainedModel):
...
class LlamaForSequenceClassification(LlamaWithHeadsAdaptersMixin, LlamaPreTrainedModel):
    def __init__(self, config):
        super().__init__(config)
